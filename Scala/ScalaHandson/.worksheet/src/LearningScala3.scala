object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def toUpperCaseExample(str: String): String={
        str.toUpperCase
  };System.out.println("""toUpperCaseExample: (str: String)String""");$skip(34); val res$3 = 
  
  toUpperCaseExample("hello");;System.out.println("""res3: String = """ + $show(res$3))}
}
